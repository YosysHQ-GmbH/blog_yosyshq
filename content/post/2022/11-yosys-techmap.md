...
date: 2022-11-24T09:38:52+02:00
description : "Yosys Techmap"
tags: ["blog"]
image: /static-2022/yosys_techmap/SB_MAC16_block_diagram.png
slug: Logic Primitive Transformations with Yosys Techmap
draft: false
---

_This guest post is by [Tom Verbeure](https://tomverbeure.github.io/)._
...
my [earlier blog post about CXXRTL](https://tomverbeure.github.io/2020/08/08/CXXRTL-the-New-Yosys-Simulation-Backend.html)
...
![top module as a graph with $mul instance](/static-2022/yosys_techmap/mul_rtlil.png)
...
[![SB_MAC16 internal block diagram](/static-2022/yosys_techmap/SB_MAC16_block_diagram.png)](/static-2022/yosys_techmap/SB_MAC16_block_diagram.png)
...
[![top module as a graph after synthesis](/static-2022/yosys_techmap/mul_ice40.png)](/static-2022/yosys_techmap/mul_ice40.png)
...
![top module after mul2dsp phase](/static-2022/yosys_techmap/mul_mul2dsp.png)

In case you were wondering, here's what this first step looks like for a 20-bit x 20-bit to 40-bit multiplier:

[![top module for $mul 20x20=40 after mul2dsp phase](/static-2022/yosys_techmap/large_mul_techmap.png)](/static-2022/yosys_techmap/large_mul_techmap.png)
*(Click to enlarge)*
...
![top_unsigned original version](/static-2022/yosys_techmap/add_orig.png)

I sometimes use [CXXRTL](https://tomverbeure.github.io/2020/08/08/CXXRTL-the-New-Yosys-Simulation-Backend.html) to simulate my designs.
...
![top_unsigned after wreduce](/static-2022/yosys_techmap/add_wreduce.png)
...
![top_unsigned after swapping inputs](/static-2022/yosys_techmap/add_swap_clean.png)
...
![top_unsigned after custom reduce](/static-2022/yosys_techmap/add_reduce.png)
...
![top_unsigned10 golden](/static-2022/yosys_techmap/add10_gold.png)

And `top_unsigned` has been transformed with the techmap: 

![top_unsigned10 reduce](/static-2022/yosys_techmap/add10_reduce.png)
...
[![top_unsigned10 equiv_make](/static-2022/yosys_techmap/add10_equiv_make.png)](/static-2022/yosys_techmap/add10_equiv_make.png)
*(Click to enlarge)*
...
![top_unsigned after custom reduce without clean](/static-2022/yosys_techmap/add_reduce_unclean.png)
